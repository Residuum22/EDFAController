...
"""
    ...
    Grouped By: Value
    Sorted By: Ref
    Fields: Ref, Qnty, Value, Cmp name, Lomex, Mouser

    Command line:
    python "pathToFile/bom_edfa.py" "%I" "%O.csv"
"""
...
out.writerow(['Ref', 'Qnty', 'Value', 'Lomex', 'Mouser'])
...
for group in grouped:
    ...
    out.writerow([refs, len(group),
        ...
        fromNetlistText( c.getField("Lomex")),
